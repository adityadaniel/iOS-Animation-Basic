...
class ViewController: UIViewController {
    ...
    var randomHeight: () -> CGFloat = { () in
        return CGFloat.random(in: 0...UIScreen.main.bounds.height)
    }
    
    var randomWidth: () -> CGFloat = { () in
        return CGFloat.random(in: 0...UIScreen.main.bounds.width)
    }
    ...
    func animatePop() {
        UIView.animate(withDuration: 1, delay: 0, usingSpringWithDamping: 1, initialSpringVelocity: 0.5, options: .transitionCurlUp, animations: {
